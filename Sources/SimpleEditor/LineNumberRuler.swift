...
final class LineNumberRuler: NSRulerView {
    ...
    override func drawHashMarksAndLabels(in rect: NSRect) {
        ...
        for (lineNumber, range) in lineRanges {
            let glyphRangeForLine = layoutManager.glyphRange(forCharacterRange: range, actualCharacterRange: nil)
            let rectForLine = layoutManager.boundingRect(forGlyphRange: glyphRangeForLine, in: textContainer)
